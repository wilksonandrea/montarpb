...
namespace System.IO
{
	...
	{
		// Token: 0x06001941 RID: 6465 RVA: 0x00053FFC File Offset: 0x000521FC
		...
		// Token: 0x06001942 RID: 6466 RVA: 0x00054090 File Offset: 0x00052290
		...
		// Token: 0x06001943 RID: 6467 RVA: 0x00054106 File Offset: 0x00052306
		internal static bool IsValidDriveChar(char value)
		{
			return (value >= 'A' && value <= 'Z') || (value >= 'a' && value <= 'z');
		}

		// Token: 0x06001944 RID: 6468 RVA: 0x00054123 File Offset: 0x00052323
		...
		// Token: 0x06001945 RID: 6469 RVA: 0x0005415C File Offset: 0x0005235C
		...
		// Token: 0x06001946 RID: 6470 RVA: 0x000541A9 File Offset: 0x000523A9
		...
		// Token: 0x06001947 RID: 6471 RVA: 0x000541D8 File Offset: 0x000523D8
		...
		// Token: 0x06001948 RID: 6472 RVA: 0x00054212 File Offset: 0x00052412
		...
		// Token: 0x06001949 RID: 6473 RVA: 0x00054236 File Offset: 0x00052436
		...
		// Token: 0x0600194A RID: 6474 RVA: 0x0005425C File Offset: 0x0005245C
		...
		// Token: 0x0600194B RID: 6475 RVA: 0x000542BC File Offset: 0x000524BC
		...
		// Token: 0x0600194C RID: 6476 RVA: 0x0005431C File Offset: 0x0005251C
		internal static bool IsExtended(string path)
		{
			return path.Length >= 4 && path[0] == '\\' && (path[1] == '\\' || path[1] == '?') && path[2] == '?' && path[3] == '\\';
		}

		// Token: 0x0600194D RID: 6477 RVA: 0x0005436C File Offset: 0x0005256C
		internal static bool IsExtended(StringBuilder path)
		{
			return path.Length >= 4 && path[0] == '\\' && (path[1] == '\\' || path[1] == '?') && path[2] == '?' && path[3] == '\\';
		}

		// Token: 0x0600194E RID: 6478 RVA: 0x000543BC File Offset: 0x000525BC
		internal static bool IsExtended(StringBuffer path)
		{
			return path.Length >= 4U && path[0U] == '\\' && (path[1U] == '\\' || path[1U] == '?') && path[2U] == '?' && path[3U] == '\\';
		}

		// Token: 0x0600194F RID: 6479 RVA: 0x0005440C File Offset: 0x0005260C
		...
		// Token: 0x06001950 RID: 6480 RVA: 0x00054470 File Offset: 0x00052670
		internal static bool IsExtendedUnc(StringBuilder path)
		{
			return path.Length >= "\\\\?\\UNC\\".Length && PathInternal.IsExtended(path) && char.ToUpper(path[4]) == 'U' && char.ToUpper(path[5]) == 'N' && char.ToUpper(path[6]) == 'C' && path[7] == '\\';
		}

		// Token: 0x06001951 RID: 6481 RVA: 0x000544D4 File Offset: 0x000526D4
		...
		// Token: 0x06001952 RID: 6482 RVA: 0x000544EE File Offset: 0x000526EE
		...
		// Token: 0x06001953 RID: 6483 RVA: 0x0005450C File Offset: 0x0005270C
		...
		// Token: 0x06001954 RID: 6484 RVA: 0x00054540 File Offset: 0x00052740
		...
		// Token: 0x06001955 RID: 6485 RVA: 0x00054574 File Offset: 0x00052774
		...
		// Token: 0x06001956 RID: 6486 RVA: 0x0005459E File Offset: 0x0005279E
		[SecuritySafeCritical]
		...
		// Token: 0x06001957 RID: 6487 RVA: 0x000545BC File Offset: 0x000527BC
		[SecurityCritical]
		...
		// Token: 0x06001958 RID: 6488 RVA: 0x0005469C File Offset: 0x0005289C
		[SecurityCritical]
		...
		// Token: 0x06001959 RID: 6489 RVA: 0x000546DC File Offset: 0x000528DC
		...
		// Token: 0x0600195A RID: 6490 RVA: 0x00054758 File Offset: 0x00052958
		...
		// Token: 0x0600195B RID: 6491 RVA: 0x000547D4 File Offset: 0x000529D4
		...
		// Token: 0x0600195C RID: 6492 RVA: 0x00054844 File Offset: 0x00052A44
		...
		// Token: 0x0600195D RID: 6493 RVA: 0x00054858 File Offset: 0x00052A58
		...
		// Token: 0x0600195E RID: 6494 RVA: 0x00054955 File Offset: 0x00052B55
