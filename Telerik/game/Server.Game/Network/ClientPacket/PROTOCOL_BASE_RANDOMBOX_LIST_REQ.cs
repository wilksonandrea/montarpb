		...
		public override void Run()
		{
			try
			{
				...
				if (player != null)
				{
					...
					if (Bitwise.ReadFile(string.Concat(Environment.CurrentDirectory, "/Data/Raws/RandomBox.dat")) != this.string_0)
					{
			...
			catch (Exception exception1)
			{
				...
				CLogger.Print(string.Concat("PROTOCOL_BASE_RANDOMBOX_LIST_REQ: ", exception.Message), LoggerType.Error, exception);
			}
		}
	}
}