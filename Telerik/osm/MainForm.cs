...
public class MainForm : Form, IMessageFilter
{
	...
	private void InitializeComponent()
	{
		...
		this.label48.Font = new System.Drawing.Font("Roboto Slab SemiBold", 14f, FontStyle.Bold | FontStyle.Italic);
		...
		this.MonitorName.Font = new System.Drawing.Font("Roboto Slab", 10f, FontStyle.Bold);
		...
		this.groupBox3.Location = new Point(16, 178);
		...
		this.groupBox2.Location = new Point(16, 163);
	...
	{
		System.Windows.Forms.DialogResult dialogResult = MessageBox.Show("Are you sure want to quit?", "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
	...
	private void MainForm_Load(object sender, EventArgs e)
	{
		...
		size = base.Size;
		base.Location = new Point(width, bottom - size.Height);
		...
		using (PrivateFontCollection privateFontCollection = new PrivateFontCollection())
		{
			...
			else
			{
				...
				string str = this.method_3(privateFontCollection.Families);
				foreach (Control font in this.method_1(this))
				{
					font.Font = new System.Drawing.Font(str, font.Font.Size, font.Font.Style);
				}
			}
		}
	...
	private IEnumerable<Control> method_1(Control control_0)
	{
		...
		controls.Push(control_0);
		while (controls.Any<Control>())
		{
	...
	private void method_2(string[] string_0, PrivateFontCollection privateFontCollection_0)
	{
		...
		{
			privateFontCollection_0.AddFontFile(string0[i]);
		}
	}

	private string method_3(FontFamily[] fontFamily_0)
	{
		FontFamily[] fontFamily0 = fontFamily_0;
		for (int i = 0; i < (int)fontFamily0.Length; i++)
		{
			FontFamily fontFamily = fontFamily0[i];
	...
	private string method_4()
	{
		...
		try
		{
			string str1 = "Config/FontSet.ini";
			if (File.Exists(str1))
			{
				string[] strArrays = File.ReadAllLines(str1, Encoding.UTF8);
				int ınt32 = 0;
				while (ınt32 < (int)strArrays.Length)
				{
					string str2 = strArrays[ınt32];
			...
			{
				MessageBox.Show(string.Concat("File Not Found! ", str1), "Warning!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return str;
			}
		}
	...
	{
		Color green;
		this.AppTitle.Text = string.Concat("Version ", GClass9.string_0);
		Label appStatus = this.AppStatus;
		if (GClass9.string_1.Equals("SERVER ONLINE"))
		{
			green = ColorUtil.Green;
		}
		else
		{
			green = (GClass9.string_1.Equals("SERVER OFFLINE") ? ColorUtil.Red : ColorUtil.White);
		}
		appStatus.ForeColor = green;
