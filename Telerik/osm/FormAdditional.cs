...
public class FormAdditional : Form
{
	...
	private void timer_0_Tick(object sender, EventArgs e)
	{
		...
		if (GClass9.string_19.Equals("Enabled"))
		{
			green = ColorUtil.Green;
		}
		else
		{
			green = (GClass9.string_19.Equals("Disabled") ? ColorUtil.Yellow : ColorUtil.Silver);
		}
		ruleIndex.ForeColor = green;
		this.InternetCafe.Text = GClass9.string_20;
		Label ınternetCafe = this.InternetCafe;
		if (GClass9.string_20.Equals("Enabled"))
		{
			color = ColorUtil.Green;
		}
		else
		{
			color = (GClass9.string_20.Equals("Disabled") ? ColorUtil.Yellow : ColorUtil.Silver);
		}
		ınternetCafe.ForeColor = color;
		this.AutoAccount.Text = GClass9.string_21;
		Label autoAccount = this.AutoAccount;
		if (GClass9.string_21.Equals("Enabled"))
		{
			green1 = ColorUtil.Green;
		}
		else
		{
			green1 = (GClass9.string_21.Equals("Disabled") ? ColorUtil.Yellow : ColorUtil.Silver);
		}
		autoAccount.ForeColor = green1;
		this.AutoBan.Text = GClass9.string_22;
		Label autoBan = this.AutoBan;
		if (GClass9.string_22.Equals("Enabled"))
		{
			color1 = ColorUtil.Green;
		}
		else
		{
			color1 = (GClass9.string_22.Equals("Disabled") ? ColorUtil.Yellow : ColorUtil.Silver);
		}
		autoBan.ForeColor = color1;
	}
}