...
namespace Plugin.Core.Models
{
	public class SlotModel
	{
		...
		public void ResetSlot()
		{
			...
			Array.Clear(this.AR, 0, (int)this.AR.Length);
			Array.Clear(this.SMG, 0, (int)this.SMG.Length);
			Array.Clear(this.SR, 0, (int)this.SR.Length);
			Array.Clear(this.SG, 0, (int)this.SG.Length);
			Array.Clear(this.MG, 0, (int)this.MG.Length);
			Array.Clear(this.SHD, 0, (int)this.MG.Length);
		}
