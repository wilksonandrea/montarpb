...
namespace Plugin.Core.Models
{
	public class AccountStatus
	{
		...
		{
			uint uInt32 = BitConverter.ToUInt32(this.Buffer, 0);
			ComDiv.UpdateDB("accounts", "status", (long)((ulong)uInt32), "player_id", this.PlayerId);
		}
		...
		public void ResetData(long PlayerId)
		{
			...
			this.SetData(-1, PlayerId);
			if (channelId != this.ChannelId || roomId != this.RoomId || clanMatchId != this.ClanMatchId || serverId != this.ServerId)
			{
