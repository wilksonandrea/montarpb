	...
	public static class AllUtils
	{
		...
		public static void CreateCharacter(Account Player, ItemsModel Item)
		{
			CharacterModel characterModel = new CharacterModel
			{
				Id = Item.Id,
				Name = Item.Name,
				Slot = GetNextAvailableSlot(Player.Character),
		...
		private static int GetNextAvailableSlot(PlayerCharacters characters)
		{
			// Slot numaraları 0'dan başlıyor ve mevcut karakterlerin slotlarını kontrol ediyoruz.
			int slot = 0;
