namespace Server.Game.Network.ClientPacket
{
    ...
    public class PROTOCOL_ROOM_CHANGE_COSTUME_REQ : GameClientPacket
    {
        ...
        public override void Run()
        {
            try
            {
                ...
                if (player != null)
                {
                    ...
                    if ((room != null) && ((this.teamEnum_0 == TeamEnum.FR_TEAM) || (this.teamEnum_0 == TeamEnum.CT_TEAM)))
                    {
                        ...
                        {
                            base.Client.SendPacket(new PROTOCOL_ROOM_CHANGE_COSTUME_ACK(slot));
                        }
            ...
            {
                CLogger.Print("PROTOCOL_ROOM_CHANGE_COSTUME_REQ: " + exception.Message, LoggerType.Error, exception);
            }
        }
    }
}
