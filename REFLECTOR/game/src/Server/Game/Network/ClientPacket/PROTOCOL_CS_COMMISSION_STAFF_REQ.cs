namespace Server.Game.Network.ClientPacket
{
    ...
    public class PROTOCOL_CS_COMMISSION_STAFF_REQ : GameClientPacket
    {
        ...
        private MessageModel method_0(ClanModel clanModel_0, long long_0, long long_1)
        {
            ...
            model1.ClanNote = NoteMessageClan.Staff;
        ...
        public override void Run()
        {
            try
            {
                ...
                if (player != null)
                {
                    ...
                    if ((clan.Id == 0) || ((player.ClanAccess != 1) && (clan.OwnerId != base.Client.PlayerId)))
                    {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                base.Client.SendPacket(new PROTOCOL_CS_COMMISSION_STAFF_ACK(this.uint_0));
                                break;
                            }
                            Account account2 = AccountManager.GetAccount(this.list_0[num], 0x1f);
                            if ((account2 != null) && ((account2.ClanId == clan.Id) && ((account2.ClanAccess == 3) && ComDiv.UpdateDB("accounts", "clan_access", 2, "player_id", account2.PlayerId))))
                            {
                                account2.ClanAccess = 2;
                                ...
                                {
                                    account2.SendPacket(new PROTOCOL_CS_COMMISSION_STAFF_RESULT_ACK(), false);
                                }
                                this.uint_0++;
                            }
                            num++;
            ...
            {
                CLogger.Print("PROTOCOL_CS_COMMISSION_STAFF_REQ: " + exception.Message, LoggerType.Error, exception);
            }
        }
    }
}
