        ...
        public override void Run()
        {
            try
            {
                ...
                if (player != null)
                {
                    ...
                    {
                        base.Client.SendPacket(new PROTOCOL_BASE_RANDOMBOX_LIST_ACK(false));
                    }
                    else
                    {
                        base.Client.SendPacket(new PROTOCOL_BASE_RANDOMBOX_LIST_ACK(true));
                    }
                }
            }
            catch (Exception exception)
            {
                CLogger.Print("PROTOCOL_BASE_RANDOMBOX_LIST_REQ: " + exception.Message, LoggerType.Error, exception);
            }
        }
    }
}
