namespace Server.Game.Network.ClientPacket
{
    ...
    public class PROTOCOL_MESSENGER_NOTE_RECEIVE_REQ : GameClientPacket
    {
        ...
        private MessageModel method_0(string string_1, long long_1, long long_2)
        {
            ...
            if (DaoManagerSQL.CreateMessage(long_1, message))
            {
                return message;
            }
        ...
        public override void Run()
        {
            try
            {
                ...
                if ((player != null) && (base.Client.PlayerId != this.long_0))
                {
            ...
            {
                CLogger.Print("PROTOCOL_MESSENGER_NOTE_RECEIVE_REQ: " + exception.Message, LoggerType.Error, exception);
            }
        }
    }
}
