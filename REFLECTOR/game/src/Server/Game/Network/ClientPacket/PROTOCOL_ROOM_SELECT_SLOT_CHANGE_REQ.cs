namespace Server.Game.Network.ClientPacket
{
    ...
    public class PROTOCOL_ROOM_SELECT_SLOT_CHANGE_REQ : GameClientPacket
    {
        ...
        public override void Run()
        {
                ...
                if (player != null)
                {
                    ...
                    if ((room != null) && !room.ChangingSlots)
                    {
                        ...
                        if ((slot != null) && (slot.State == SlotState.NORMAL))
                        {
                            ...
                            if (((newSlot != null) && ((newSlot.Team == room.CheckTeam(this.int_0)) && (newSlot.PlayerId == 0))) && (newSlot.State == SlotState.EMPTY))
                            {
            ...
            {
                CLogger.Print("PROTOCOL_ROOM_SELECT_SLOT_CHANGE_REQ: " + exception.Message, LoggerType.Error, exception);
            }
        }
    }
}
